		...
		<div class="body page-result">
			<header id="header" class="navbar-fixed-top">
				<div class="header-container">
					...
					<div id="search-box">
						<form action="/search">
							<input type="text" id="search-input" name="k" class="form-control" placeholder="Search thousands of coupons and stores" v-model="keyword" autocorrect="off" spellcheck="false">
							...
							<div class="search-result" v-for="(search_data, index) in data_list" v-bind:key="index">
								<div v-if="search_data !== null">
									...
									<a class="search-link" target="_blank" v-bind:href="search_data.url" style="color: #006621;">
										{{search_data.url.length > 60 ? search_data.url.slice(0, 60) + '...' : search_data.url}}
									</a>
