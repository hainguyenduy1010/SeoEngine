<template>
    <b-container fluid="md" class="create-form pb-3">
        <b-form @submit.stop.prevent="onSubmit">
            ...
            <b-row class="keyword-row" align-v="center">
                ...
                <b-col>
					...
					<div v-show="!keyword" class="invalid-feedback keyword-invalid-feedback">Keyword is required.</div>
                </b-col>
            </b-row>
            ...
            <div v-for="(row, index) in rows" v-bind:key="index">
                <b-row align-v="center">
                    ...
                    <b-col cols="1.5">
                        <vue-numeric-input class="number-input" v-model="row.order" :min="1"
            ...
            <b-row class="mt-3">
                <b-col cols="1" class="text-center">
                    <b-button size="sm" class="add-btn" variant="success" @click="onAdd">+</b-button>
                </b-col>
            </b-row>
        </b-form>
    </b-container>
